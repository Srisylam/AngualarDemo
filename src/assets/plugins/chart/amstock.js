(function() {
    ...
    e.AmStockChart = e.Class({
        ...
        parseStockData: function(a, b, c, d, k) {
                ...
                for (q = 0; q < t; q++) {
                    ...
                    for (z = f; z < m; z++) {
                        ...
                        if (z == f || C >= y[p] || !y[p]) {
                            ...
                            w.rawData.push(B);
                            l[p].push(v[p]);
                            z > f && (u = e.newDate(D, b), u = e.changeDate(u, F, G, !0), u = e.resetDateToMin(u, F, G, d), y[p] = u.getTime());
                            if (z == f)
            ...
            e.ifArray(a.stockEvents) ? 0 < g.processTimeout ? setTimeout(function() {
                g.parseEvents.call(g, a, g.panels, g.stockEventsSettings, g.firstDayOfWeek, g, g.dataDateFormat)
            }, g.processTimeout) : g.parseEvents(a, g.panels, g.stockEventsSettings, g.firstDayOfWeek, g, g.dataDateFormat) : (a.dataParsed = !0, g.onDataUpdated())
        },
        parseEvents: function(a, b, c, d, k, g) {
            d = a.stockEvents;
            d.sort(function(a, b) {
                return a.showOnAxis || b.showOnAxis ? (1 == a.showOnAxis) - (1 == b.showOnAxis) : isNaN(a.value) && isNaN(b.value) ? 0 : !isNaN(a.value) - !isNaN(b.value)
            });
            ...
            for (n = 0; n < h; n++) {
                ...
                t = p.graphs;
                m = t.length;
                for (f = 0; f < m; f++) q = t[f], q.customBulletField = "amCustomBullet" + q.id + "_" + p.id, q.bulletConfigField = "amCustomBulletConfig" + q.id + "_" + p.id, q.chart = p;
                for (f = 0; f < d.length; f++) m = d[f], q = m.graph, e.isString(q) && (q = e.getObjById(t, q)) && (m.graph = q), q && (m.panel = q.chart)
            }
            for (var y in l)
                if (l.hasOwnProperty(y))
                    for (b = l[y], h = e.extractPeriod(y), n = b.length, f = 0; f < d.length; f++) {
                        m = d[f];
                        q = m.date instanceof Date;
                        g && !q && (m.date = e.stringToDate(m.date, g));
                        q = m.date.getTime();
        ...
        getEventDataItem: function(a, b, c, d, k, g) {
            ...
            l = "fff" == l ? m.getTime() + 1 : e.resetDateToMin(e.changeDate(new Date(m), g.period, g.count), l, h, this.firstDayOfWeek).getTime();
            if (a >= q && a < l) return f;
            if (!(1 >= k - d)) return a < q ? this.getEventDataItem(a, b, c, d, n, g) : this.getEventDataItem(a, b, c, n, k, g)
        },
        ...
        measurePanels: function(a) {
            ...
            if (this.div) {
                ...
                if (c != this.prevPH) {
                    ...
                    for (var d = 0, g, b = 0; b < a.length; b++)
                        if (g = a[b]) {
                            var l = g.percentHeight;
                            isNaN(l) && (l = 100 / a.length, g.percentHeight = l);
                            d += l
                        }
        ...
        addStockPanel: function(a, b) {
            ...
            d.className = "amChartsPanel " + this.classNamePrefix + "-stock-panel-div " + this.classNamePrefix + "-stock-panel-div-" +
                a.id;
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (0 < a.dataProvider.length) {
                        var g = this.chartScrollbarSettings.usePeriod;
                        if (g) {
                            var l = a.agregatedDataProviders[d],
                                h = a.categoryField,
                                n = this.getFirstDate(l[0][h]).getTime();
                            this.getLastDate(l[l.length - 1][h]).getTime() - n < e.getPeriodDuration(g) && (g = d);
                            b.dataProvider = a.agregatedDataProviders[g]
            ...
            if (a.enabled) {
                ...
                if (e.isString(d)) {
                    ...
                    for (k = 0; k < c.length; k++) {
                        var g = e.getObjById(c[k].stockGraphs, a.graph);
                        g && (d = g)
                    }
                    a.graph = d
                }
        ...
        addCursor: function(a) {
            ...
            if (b.enabled) {
                var c = e.processObject(a.chartCursor, e.ChartCursor, this.theme);
        ...
        zoomChart: function(a, b) {
            ...
            if (k && g) {
                ...
                if (l) {
                    ...
                    a.getTime() == b.getTime() && v != n && (b = e.changeDate(b, v.period, v.count), b.setTime(b.getTime() -
                        1))
                }
                ...
                v = e.newDate(a);
                c.extendToFullPeriod && (v.getTime() - k.getTime() < .1 * A && (v = e.resetDateToMin(a, n.period, n.count, y)), g.getTime() - b.getTime() < .1 * A && (b = e.resetDateToMin(g, n.period, n.count, y), b = e.changeDate(b, n.period, n.count, !0)));
                for (k = 0; k < q.length; k++) g = q[k], g.chartCursor && g.chartCursor.panning && (v = d);
                for (k = 0; k < q.length; k++) {
                    ...
                    if (l != h) {
                        ...
                        d.firstDayOfWeek = y;
                        d.minPeriod = l;
                        g.dataProvider = c.mainDataSet.agregatedDataProviders[l];
                        if (d = g.chartCursor) d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(n.period), g.showCategoryAxis || (d.categoryBalloonEnabled = !1);
                ...
                c.animationPlayed = !0;
                f = e.newDate(b);
                p && c.updateScrollbar && (p.zoomToDates(a, f), c.skipScrollbarEvent = !0, setTimeout(function() {
                    c.resetSkip.call(c)
                }, 100));
                c.updateScrollbar = !0;
                c.startDate = a;
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        for (h = 0; h < q.length; h++) {
                            ...
                            var t = f.valueField;
                            t && n.toField == t && (m = !0);
                            (t = f.openField) && n.toField == t && (m = !0);
                            (t = f.closeField) && n.toField == t && (m = !0);
                            (t = f.lowField) && n.toField == t && (m = !0)
                        }
                        c.graphs.push(f);
                        c.processGraphs();
                        f.hideFromLegend = m ? !1 : !0;
                        t = !1;
                        ...
                        if (f.comparable) {
                            ...
                            if (f.valueAxis) {
                                ...
                                p && f.valueAxis && !0 === f.valueAxis.recalculateToPercents && (t = !0);
                                var D;
                                for (D = 0; D < B; D++) {
                                    var C = k[D],
                                        r = f.comparedGraphs[C.id];
                                    r || (r = new e.AmGraph(this.theme), r.id = "comparedGraph_" + f.id + "_" + C.id);
                                    f.compareGraphType && (r.type = f.compareGraphType);
                                    f.compareGraph && (e.copyProperties(f.compareGraph, r), f.compareGraph.balloon && (r.balloon = {}, e.copyProperties(f.compareGraph.balloon, r.balloon)));
                                    ...
                                    z || (z = f.valueField);
                                    r.customBulletsHidden = !f.showEventsOnComparedGraphs;
                                    m = !1;
                                    q = C.fieldMappings;
                                    for (h = 0; h < q.length; h++) n = q[h], n.toField == z && (m = !0);
                                    if (m) {
                                        r.valueField = z;
                                        r.title = C.title ? C.title : f.title;
                                        r.lineColor = C.color;
                                        ...
                                        if (h = f.compareGraphFillColors) r.fillColors = h;
                                        if (h = f.compareGraphNegativeFillColors) r.negativeFillColors = h;
                                        if (h = f.compareGraphFillAlphas) r.fillAlphas = h;
                                        if (h = f.compareGraphNegativeFillAlphas) r.negativeFillAlphas = h;
                                        if (h = f.compareGraphBullet) r.bullet = h;
                                        if (h = f.compareGraphNumberFormatter) r.numberFormatter = h;
                                        h = f.compareGraphPrecision;
                                        isNaN(h) || (r.precision = h);
                                        if (h = f.compareGraphBalloonText) r.balloonText = h;
                                        ...
                                        if (h = f.compareGraphBulletBorderColor) r.bulletBorderColor = h;
                        ...
                        p && (t && y ? (f.legendValueTextR = y, f.legendPeriodValueTextR = A) : (v && (f.legendValueTextR = v), f.legendPeriodValueTextR = E))
                    }
                }
            }
        },
        ...
        choosePeriod: function(a, b, c) {
            ...
            return (f -
                n) / h > m && 0 < m && l ? this.choosePeriod(a + 1, b, c) : g
        },
        getSelections: function() {
            ...
            b = this.panels;
            for (c = 0; c < b.length; c++) d = b[c], d.hideDrawingIcons && ("never" != d.recalculateToPercents && 0 < a.length ? d.hideDrawingIcons(!0) : d.drawingIconsEnabled && d.hideDrawingIcons(!1))
        },
        addPanel: function(a) {
            this.panels.push(a);
            this.prevPH = void 0;
        ...
        showHideEvents: function(a) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                for (e = 0; e < d.length; e++) {
                    var g = d[e];
                    !0 === a ? g.showCustomBullets(!0) : g.hideCustomBullets(!0)
                }
            }
        },
    ...
    e.PeriodSelector = e.Class({
        ...
        write: function(a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                n.appendChild(m);
                b.startDateField = m;
                if (k) f = b.width - 6 + "px", e.addBr(n);
                else {
                    var f = b.inputFieldWidth + "px",
...
(function() {
    ...
    e.StockPanel = e.Class({
        ...
        handleDraw: function(a) {
            ...
            l.initialValue = b.coordinateToValue(g);
        ...
        handleWheelReal: function(a, b) {
            ...
            if (!this.wheelBusy && c) {
                ...
                if (d != e) var g = this.mouseX / this.plotAreaWidth,
                    d = d * g,
                    e = e * (1 - g);
                if (c = c.chartScrollbar) c.getPercents(), g = .05 * (c.percentEnd - c.percentStart), .005 > g && (g = .005), 0 > a ? (d = c.percentStart + d * g, e = c.percentEnd + e * g) : (d = c.percentStart - d * g, e = c.percentEnd - e * g), e > d && c.percentZoom(d, e, !0)
            }
        }
    })
})();
        ...
        write: function(a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                for (c = 0; c < g.length; c++)
                    if (n = g[c], !0 === n.showInSelect) {
                        f = document.createElement("option");
                        f.className = k.classNamePrefix + "-data-set-select-option";
                        f.text = n.title;
                        f.value = c;
                        n == b.chart.mainDataSet && (f.selected = !0);
                        try {
                            m.add(f, null)
                        } catch (q) {
                            m.add(f)
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < g.length)
                if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), f = b.listCheckBoxSize, l) {
                    e.addBr(a);
                    ...
                    for (c = 0; c < g.length; c++) n = g[c], !0 === n.showInCompare && n != b.chart.mainDataSet && (d = document.createElement("div"), d.style.padding = "4px", d.style.position = "relative", d.name = "amCBContainer", d.className = k.classNamePrefix + "-compare-item-div", d.dataSet = n, d.style.height = f + "px", n.compared && (d.style.backgroundColor = b.selectedBackgroundColor), h.appendChild(d), l = document.createElement("div"), l.style.width = f + "px", l.style.height = f + "px", l.style.position = "absolute", l.style.backgroundColor = n.color, d.appendChild(l), l = document.createElement("div"), l.style.width = "100%", l.style.position = "absolute", l.style.left = f + 10 + "px", d.appendChild(l), n = document.createTextNode(n.title), l.style.whiteSpace = "nowrap", l.style.cursor = "default", l.appendChild(n), b.addEventListeners(d));
                    e.addBr(a);
                    e.addBr(a)
                } else {
                    ...
                    for (c = 0; c < g.length; c++)
                        if (n = g[c], !0 === n.showInCompare && n != b.chart.mainDataSet) {
                            f = document.createElement("option");
                            f.text = n.title;
                            f.value = c;
                            n.compared && (f.selected = !0);
                            try {
                                d.add(f, null)
                            } catch (q) {
                                d.add(f)
...
(function() {
    ...
    e.StackedBullet = e.Class({
        ...
        addLetter: function(a, b, c) {
            ...
            this.bullets[c] = v;
            this.showOnAxis ? (m = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY, f = h * k, this.nextAxisY = m + k * d) : this.value ? (m = this.value, l.recalculateToPercents && (m = m / l.recBaseValue * 100 - 100), m = l.getCoordinate(m) - this.bulletY, f = h * k) : this.showAt ? (v = this.graphDataItem.values, l.recalculateToPercents && (v = this.graphDataItem.percents), v && (m = l.getCoordinate(v[this.showAt]) - this.bulletY, f = h * k)) : (m = this.nextY, f = h * k);
            a.translate(n, f);
            b.push(a);
            b.translate(0, m);
        ...
        handleMouseOver: function(a, b) {
            ...
            c = d.graphs;
            if (d.chartCursor && d.chartCursor.valueBalloonsEnabled)
